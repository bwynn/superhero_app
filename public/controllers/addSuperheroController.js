var addCtrl = angular.module('addSuperheroCtrl', [])
  .controller('addSuperheroController', function($scope, $http, filepickerService) {
    ...
    $scope.createSuperhero = function() {
      $http.post('/superhero', $scope.superhero).
        success(function(data) {
          ...
          // clean the form to allow the user to create new superheros
          $scope.superhero = {};
        }).
        error(function(data) {
    ...
    // multiple upload set to 3 as max number
